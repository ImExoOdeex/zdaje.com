import { Flex, Heading, ListItem, UnorderedList, Button, useColorMode, useColorModeValue, chakra, Text, IconButton } from '@chakra-ui/react'
            ...
            <Flex m={'auto'} w='1300px' bg={'tansparent'} h='100%' justifyContent={'space-between'}>
                ...
                <Flex alignItems={'center'} mr='40px' display={{ base: 'none', sm: 'flex' }}>
                    <UnorderedList listStyleType={'none'} display='inline-flex'>
                        ...
                        <ListItem ml={'20px'}><Link href={'zwykla'} _hover={{ borderBottom: '2px solid' }}>Zwykła</Link></ListItem>
                        <ListItem ml={'20px'}><Link href={'wazona'} _hover={{ borderBottom: '2px solid' }}>Ważona</Link></ListItem>
                    </UnorderedList>
                    <MotionButton whileHover={{ rotate: colorMode === "dark" ? 10 : -10, transition: { duration: 0.1 } }} p='2' px='3' rounded='md' ml={'10px'}
